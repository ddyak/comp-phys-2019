...
// ЧТо такое жесткие уравнения?
// Что такое неявное жесткое уравнение, схема, границы применимости?
// Вычестить с явной разницой (график)
// Двумерный график 
// 
// 6: 
// Подставить производную в конечно-разностную схему
// Найти схему, нарисовать ошибку от количества точек.